  ...
  if (!isset($_COOKIE['login'])) {
	...
	<form id="form" action="<?php echo $_SERVER['PHP_SELF']; echo '" F'; if(isset($_POST['roomtitle'])) { echo 'style="display:none;"'; }?> method="post">
        <div style="border: 1px solid; color: red; background-color: pink; padding: 7px; border-radius: 7px;">
            ...
            <ul>
                <li>Choose a descriptive title. Titles cannot be changed later.</li>
                <li><a href="search.php">Search</a> for what you are asking first to make sure it doesn't exist.</li>
                <li>Write details in the body.</li>
                <li>Add some descriptive tags, but not <a href="faq.php#tags">too many</a>. If you have JavaScript enabled, you can use the tag search box, although only the tags in the top text box will be saved.</li>
                <li>We are excited to see what you can write! Thank you.</li>
            </ul>
        </div>
